...
function preload() {
  ...
  function createButtons() {
      ...
      button.position($(window).width()/2 - 90,100+295)
  ...
  function startFightGo() {
        ...
        canMoveB = true
          ...
          resetButton.position($(window).width()/2 - 90,100+500)
